    ...
    */
    ...
    public function productsStore(Request $request)
    {
        $request->validate([
            ...
            'seo_meta_key'         => 'nullable|string|max:500',
            ...
            'og_meta_description' => 'nullable|string|max:500',
            'og_meta_key'         => 'nullable|string|max:500',
        ...
        */
        ...
        if ($request->hasFile('image')) {
            $imageName = 'product_' . time() . '_' . uniqid() . '.' .
        ...
        */
        ...
        if ($request->hasFile('seo_meta_image')) {
            $seoImageName = 'seo_' . time() . '_' . uniqid() . '.' .
            ...
            $data['seo_meta_image'] = $seoImageName;
        }
        ...
        */
        ...
        if ($request->hasFile('og_meta_image')) {
            ...
            $data['og_meta_image'] = $ogImageName;
        }
        ...
        */
        ...
        if ($request->hasFile('seo_meta_image')) {
            if (
                ...
                file_exists(public_path('images/' . $product->seo_meta_image))
            ) {
                unlink(public_path('images/' . $product->seo_meta_image));
            }
        ...
        */
        ...
        if ($request->hasFile('og_meta_image')) {
            if (
                ...
                file_exists(public_path('images/' . $product->og_meta_image))
            ) {
                unlink(public_path('images/' . $product->og_meta_image));
            }
    ...
    public function productsDestroy($id)
    {
        ...
        foreach ($images as $image) {
            if (
                $image &&
                file_exists(public_path('images/' . $image))
            ) {
    ...
    */
    ...
    public function settingsUpdate(Request $request)
    {
        $request->validate([
            ...
            'return_policy_url' => 'nullable|url|max:500',
        ...
        $data = [
            ...
            'return_policy_url' => $request->return_policy_url,
        ...
        */
        ...
        if ($request->hasFile('site_logo')) {
            if (
                $settings->site_logo &&
                file_exists(public_path('images/' . $settings->site_logo))
            ) {
                unlink(public_path('images/' . $settings->site_logo));
            }

            $logoName = 'logo_' . time() . '_' . uniqid() . '.' .
        ...
        */
        ...
        if ($request->hasFile('site_favicon')) {
            if (
                ...
                file_exists(public_path('images/' . $settings->site_favicon))
            ) {
                unlink(public_path('images/' . $settings->site_favicon));
            }

            $faviconName = 'favicon_' . time() . '_' . uniqid() . '.' .
